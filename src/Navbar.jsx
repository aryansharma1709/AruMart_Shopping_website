  ...
  return (
    <div class="py-2 bg-white">
        <div className=" max-w-6xl flex justify-between mx-auto items-center">
         ...
         <div>
           <div className="hover:text-primary-dark cursor-pointer text-sm " on><Link to="/login">Login/SignUp</Link></div>
          <div className="relative ">
          <span className=" px-1 absolute right-6 top-0 rounded-full bg-primary-dark text-white " >{data.productCount}</span>
